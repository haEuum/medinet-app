...
const Token = {
    ...
    getToken: async (token: string, useBiometrics = false): Promise<string | null> => {
        try {
            ...
            if (credentials && typeof credentials === "object" && "password" in credentials) return credentials.password;
