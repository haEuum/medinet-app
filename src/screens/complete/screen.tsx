...
const Screen = () => {
    ...
    const handleSignup = async (biometricAuthNum: number) => {
        try {
            ...
            console.log("biometricAuthNum :", biometricAuthNum);
            await signUp({
                ...
                <View style={styles.completeView}>
                    <View style={styles.textView}>
                        ...
                        <View style={styles.text}>
                            <PretendardText variant='HeadLine2Bold'>회원가입이 완료되었어요!</PretendardText>
                            <PretendardText variant='BodyRegular'>생체 인증을 하면 더 편리하게 로그인이 가능해요</PretendardText>
                        </View>
                    </View>
                    <View style={styles.buttonContainer}>
                        <Button fullWidth onClicked={() => handleSignup(1)} size="small">생체 인증</Button>
                        <Button
                            fullWidth
